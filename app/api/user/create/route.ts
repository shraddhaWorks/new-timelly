...
export async function POST(req: NextRequest) {
  try {
    ...
    const { name, email, role, designation, username, password, allowedFeatures } =
      await req.json();
    ...
    // Create user (username is currently validated on frontend and accepted here but
    // not yet stored in the database schema)
