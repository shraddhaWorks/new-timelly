...
export const SCHOOLADMIN_MENU_ITEMS: SidebarItem[] = [
  ...
  },
  {
    label: "TC Approvals",
    tab: "tc-approvals",
    href: "/frontend/pages/schooladmin?tab=tc-approvals",
    icon: FiFileText,
    permission: Permission.TC_APPROVALS,
  },
  {
    label: "Fee Payments",
    tab: "payments",
    href: "/frontend/pages/schooladmin?tab=payments",
    icon: FiCreditCard,
  ...
  },
  {
    label: "New User",
    tab: "new-user",
    href: "/frontend/pages/schooladmin?tab=new-user",
    icon: FiUser,
